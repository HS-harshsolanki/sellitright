  ...
  return (
    <>
      ...
      <p className="mt-6 text-center text-xs text-[var(--color-muted-foreground)]">
        ...
        <Link href="/terms" className="underline underline-offset-4 hover:text-[var(--color-foreground)]">
          Terms
        </Link>{' '}
        and{' '}
      ...
      <p className="mt-4 text-center text-sm text-[var(--color-muted-foreground)]">
        ...
        <Link href="/login" className="font-medium text-[var(--color-primary)] underline-offset-4 hover:underline">
          Sign in
        </Link>
      </p>
    </>
